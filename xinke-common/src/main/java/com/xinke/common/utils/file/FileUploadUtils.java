package com.xinke.common.utils.file;
...
import com.xinke.common.exception.file.FileNameLengthLimitExceededException;
import com.xinke.common.exception.file.FileSizeLimitExceededException;
import com.xinke.common.exception.file.InvalidExtensionException;
...
import com.xinke.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = XinKeConfig.getProfile();
    ...
    {
        int dirLastIndex = XinKeConfig.getProfile().length() + 1;
