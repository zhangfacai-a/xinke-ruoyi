...
import com.xinke.common.utils.ServletUtils;
import com.xinke.common.utils.StringUtils;
import com.xinke.common.utils.http.UserAgentUtils;
import com.xinke.common.utils.ip.AddressUtils;
import com.xinke.common.utils.ip.IpUtils;
import com.xinke.common.utils.uuid.IdUtils;
...
public class TokenService
{
    ...
    public LoginUser getLoginUser(HttpServletRequest request)
    {
        ...
        if (StringUtils.isNotEmpty(token))
        {
            try
            {
                ...
                return getLoginUserByKey(userKey);
            }
            catch (Exception e)
            {
    ...
    public void refreshPermissionByRoleId(Long roleId, SysPermissionService permissionService)
    {
        ...
        for (String key : keys)
        {
            LoginUser loginUser = getLoginUserByKey(key);
    ...
    private LoginUser toLoginUser(Object cacheObject)
    {
        if (cacheObject == null)
        {
            return null;
