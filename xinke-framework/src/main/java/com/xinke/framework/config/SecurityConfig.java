...
import com.xinke.framework.security.handle.AuthenticationEntryPointImpl;
import com.xinke.framework.security.handle.LogoutSuccessHandlerImpl;
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception
    {
        return httpSecurity
            ...
            .authorizeHttpRequests((requests) -> {
                ...
                requests.requestMatchers("/login", "/register", "/captchaImage","/live-bi").permitAll()
                    // 静态资源，可匿名访问
